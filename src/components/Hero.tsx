      ...
      >
        <div className="hero-grid w-full min-w-0">
          ...
          >
            ...
            <span className="hero-headline__desktop-only block">
              <em className="theme-transition italic text-[var(--text-secondary)]">
                engineers.
              </em>
            </span>
          ...
          >
            <motion.a
              ...
              whileHover={{ y: -2, boxShadow: "0 10px 32px rgba(0,0,0,0.16)" }}
              whileTap={{ scale: 0.98 }}
          ...
          <motion.div
            ...
            aria-hidden
          >
            <LiquidGlass className="hero-video__glass">
