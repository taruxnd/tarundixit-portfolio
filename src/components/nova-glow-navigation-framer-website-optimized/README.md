# nova-glow-navigation-framer-website

A Next.js project generated from [https://nova-glow-navigation.framer.website/](https://nova-glow-navigation.framer.website/) by [FNJ](https://framertonextjs.com).

## What this is

3 page(s) built from 2 React section component(s). Unlike a
