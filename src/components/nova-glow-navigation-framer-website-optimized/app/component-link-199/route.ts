...
import View from "../../src/views/ComponentLink199Page";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("component-link-199.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "component-link-199.html"), "utf8");
